...
\flushright{75 Thayer St. Apt. 1G\\
New York, NY 10040\\
james.whang@nyu.edu\\
...
Acoustic phonetics, computational modeling, crosslinguistic perception, laboratory phonology, language acquisition, lexical representation, loanword phonetics and phonology, phonotactic learning, reduction and recoverability, speech perception.

\subsection*{Education}
\begin{tabular}{L!{\VRule}R}
2011-&PhD in Linguistics, NYU (expected August 2016).\\[5pt]
...
\begin{tabular}{L!{\VRule}R}
Submitted & James Whang and Frans Adriaans. Learning to reduce and recover: the role of phonotactics and alternations in Japanese high vowel reduction.\\[5pt]
Under revision & James Whang. Recoverability-driven gestural coordination: Acoustic evidence from Japanese high vowel reduction. \emph{Journal of the Acoustical Society of America}.\\[5pt]
...
\begin{tabular}{L!{\VRule}R}
In prep & James Whang. Shaping speech patterns via predictability and recoverability. Dissertation, NYU.\\
...
\subsection*{Teaching}
\begin{tabular}{L!{\VRule}R}
\multicolumn{2}{l}{\emph{NYU}}\\[5pt]
Fall 2015 & Language (undergraduate introduction to linguistics).\\
& Teaching assistant to Maria Gouskova.\\[5pt]
Fall 2014 & Sound and Language (undergraduate phonetics).\\
& Teaching assistant to Lisa Davidson.\\[5pt]
Spring 2014 & Language (undergraduate introduction to linguistics).\\
...
\begin{tabular}{L!{\VRule}R}
2014& Research assistant for Frans Adriaans. Checking and remeasuring vowel pitch information of English infant-directed speech corpus.\\[5pt]
2013& Research assistant for Lisa Davidson. Checking and resegmentation of forced aligner segmented English speech recordings.\\[5pt]
2012& Research assistant for Gillian Gallagher. Segmentation of Quechua speech recordings.\\
\end{tabular}

\subsection*{Services}
\begin{tabular}{L!{\VRule}R}
2016 & Reviewer for the 15th Conference on Laboratory Phonology (LabPhon15).\\
...
\begin{tabular}{L!{\VRule}R}
2003-11& Freelance translator and interpreter (Japanese and Korean)\\
& Specialized in translation of legal documents and doctoral thesis in theology.\\
