...
\begin{document}
	...
	\begin{longtable}{L!{\VRule}R}
		04.2020--01.2021 & New Faculty Research Grant. Seoul National University. \\
...
%		& Recitation leader and guest lecturer (acoustic analysis).\\%[10pt]
	...
	\begin{longtable}{L!{\VRule}R}
		...
		Articles & \textit{J. Laboratory Phonology; J. Experimental Psychology: Learning, Memory, and Cognition; Applied Psycholinguistics; Speech Communication}.\\
		Abstracts & ``15th Conference on Laboratory Phonology (LabPhon15)''; ``Annual Meeting on Phonology (AMP) 2020''.\\[10pt]
