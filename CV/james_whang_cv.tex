...
\begin{document}
	...
	\begin{longtable}{L!{\VRule}R}
		...
		under review & K. Yazawa, \textbf{J. Whang}, and P. Escudero. ``English Listeners' Perception of Nonnative Vowel Length Reveals Underlying Phonological Knowledge''.\\

		accepted & K. Yazawa, T. Konishi, M. Kondo, \textbf{J. Whang}, and P. Escudero. ``Spectral and temporal implementation of Japanese speakers' English vowel categories: A corpus-based study''. \emph{Laboratory Phononology: Journal of the Association for Laboratory Phonology}\\
