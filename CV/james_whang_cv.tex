...
\begin{document}
	...
	\begin{tabular}{L!{\VRule}R}
		submitted & \textbf{J. Whang}, K. Yazawa, and P. Escudero. ``Perception of Japanese vowel length by Australian English listeners''.\\
		submitted & A. Tuninetti, \textbf{J. Whang}, and P. Escudero. ``Non-native vowel perception in a 4IAX task: The effects of acoustic distance''.\\
		under revision & \textbf{J. Whang}. ``Effects of phonotactic predictability on sensitivity to phonetic detail''.\\
	...
	\begin{tabular}{L!{\VRule}R}
		in prep & J. Whang. ``Reconciling CV phonotactics and high vowel deletion in Japanese''. \emph{Supplementary Proceedings of the 2018 Annual Meeting on Phonology}.\\
